...
# join options featureRankedList or featureRankedList4join
...
```
With RFE ranked bins highest accuracy classification is %65 with 10 bins when use 75 bins from control vs. pesticide on control vs. pesticide + bullfrog. 
