...
# Tom's computer -> NOT SET UP
if(Sys.info()[4]=="FILL IN HERE"){
  datadir<-path.expand("FILL IN HERE") # path to git repo
}
...
Format data pre-processed (retention time aligned and scaled) data for format to create null control and exposure from control data.
```{r create null data}
# run function 10x
